...
class DropdownMenu extends Component {
  ...
  constructor(props, context) {
    ...
    var isTouched = new Array(this.props.data.length);
    isTouched.fill(false);
  ...
  itemOnPress(index) {
    if (this.state.activityIndex > -1) {
      ...
      if (this.state.isTouched[this.state.activityIndex] === false) {
        this.state.isTouched[this.state.activityIndex] = true;
      }
              ...
              <TouchableOpacity
                ...
                <View style={{ flexDirection: 'row', alignItems: "center", justifyContent: "center" }} >
                  <Text
                    ...
                    {(this.state.isTouched[index] === false && this.props.titles) ? this.props.titles[index] : rows[this.state.selectIndex[index]]}
                  </Text>
